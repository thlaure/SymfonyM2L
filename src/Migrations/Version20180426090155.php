 ...
 */
class Version20180426090155 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE atelier_avis (atelier_id INT NOT NULL, avis_id INT NOT NULL, INDEX IDX_4F16221382E2CF35 (atelier_id), INDEX IDX_4F162213197E709F (avis_id), PRIMARY KEY(atelier_id, avis_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE atelier_avis ADD CONSTRAINT FK_4F16221382E2CF35 FOREIGN KEY (atelier_id) REFERENCES atelier (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE atelier_avis ADD CONSTRAINT FK_4F162213197E709F FOREIGN KEY (avis_id) REFERENCES avis (id) ON DELETE CASCADE');
    }
